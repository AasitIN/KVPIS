...
class Profile_model extends CI_Model {
    ...
    public function getinitialServiceData($ExEc = NULL){
        $this->db->select('E.*,D.name as designationname,D.cat_id,S.name as subjectname,r.name as rolename,re.name as region,sc.name as school,rc.name as section,reg.name as initial_zone,DATE_FORMAT(E.initial_joiningdate,"%d-%m-%Y") as initial_joiningdate,DATE_FORMAT(E.initial_trailsdate,"%d-%m-%Y") as initial_trailsdate,DATE_FORMAT(E.initial_trailedate,"%d-%m-%Y") as initial_trailedate,DATE_FORMAT(E.initial_regulardate,"%d-%m-%Y") as initial_regulardate');
    ...
    public function getallServiceData($ExEc = NULL){
        $this->db->select('E.*,D.name as designationname,D.cat_id,S.name as subjectname,r.name as rolename,re.name as region,sc.name as school,rc.name as section,DATE_FORMAT(E.all_fromdate,"%d-%m-%Y") as s_from,DATE_FORMAT(E.all_todate,"%d-%m-%Y") as s_to,DATE_FORMAT(E.all_trailsdate,"%d-%m-%Y") as alltrailstart,DATE_FORMAT(E.all_trailedate,"%d-%m-%Y") as alltrailend,DATE_FORMAT(E.all_regulardate,"%d-%m-%Y") as alltrailregular');
