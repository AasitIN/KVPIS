        ...
        <div class="col-md-12 p-2 pt-2">
           ...
           <h6>Details of First Joining in KVS : </h6>    
            ...
            <table width="100%" cellpadding="5">
                ...
                <tr>
                    <td style=""><b>Appointment on Zonal Basis </b></td><td style="">:</td><td style=""><?php echo single_parent($InitialServiceData->initial_appoint_zone); ?></td>
                    <?php if($InitialServiceData->initial_appoint_zone == 1) { ?><td style=""> <b>Zone</b></td><td style="">:</td><td style=""><?php echo  ucfirst($InitialServiceData->initial_zone); ?></td><?php } ?>
    ...
    <?php if(count($OtherData) > 0): ?>    
        ...
        <div class="col-md-12 p-2 pt-2">
           <h6>Other Details : </h6>    
            ...
            <table width="100%" cellpadding="5">
                <tr>
                    <td><b>Due Date of Retirement</b></td><td>:</td><td><?php echo $OtherData->due_date_retirement; ?></td>
                    <td ><b>Age below 40 Years</b></td><td style="">:</td><td style=";"><?php echo single_parent($OtherData->is_below_40_years); ?></td>
                 </tr>
