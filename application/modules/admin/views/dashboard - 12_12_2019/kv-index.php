            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-sm-6 mb-3">
                    <div class="card text-white bg-success o-hidden h-100">
                        ...
                        <a class="card-footer text-white clearfix small z-1" href="<?php echo base_url(); ?>swap/pending_for_approval">
                ...
                <div class="col-xl-3 col-sm-6 mb-3">
                    <div class="card text-white bg-danger o-hidden h-100">
                        ...
                        <a class="card-footer text-white clearfix small z-1" href="<?php echo base_url(); ?>employee/index">
...
var title = chart.titles.create();
title.html = "No. of Sanctioned / In-Positions / Vacancy of Designations at KV";
title.fontSize = 16;
...
var valueAxis = chart.yAxes.push(new am4charts.ValueAxis());
valueAxis.title.text = "Designations / Posts";
valueAxis.title.fontWeight = "bold";
// Create series
